	    		...
	    		<div class="row">
	      			<div class="col-md-12">
	          			...
	          			<div id="aze" class="embed-responsive embed-responsive-16by9">
	          				<iframe class="movie embed-responsive-item" src="https://www.youtube.com/embed/<?php echo $movie[0]['CODE']; ?>?rel=0&loop=1&hd=1&vq=hd1080&playlist=<?php echo $movie[0]['CODE']; ?>&modestbranding=1&controls=0"></iframe>
			  			</div>
	      			</div>
				</div>
	    	</div>
        ...
        <div class="container">
        	<div class="row">	
        		<div class="col-xs-12">
        			...
        			?>
		        	<?php echo gethostname()." Temps de chargement : ".$page_load_time = number_format($time, 3)." | Memoire allou� : ".round(memory_get_usage()/1024,2)." ko";?>
        		</div>
      		</div>
        </div>
    </nav> 
